...
export default function Comment({ profileSrc, username, createdAt, comment, feedbackCount }) {
  return (
    <section className="card">
      <div className="card__flex-header">
        <img className="card__picture" src={profileSrc} alt="profile-picture" />
        <p className="card__name">
          {username} <span className="card__published-date">{createdAt} ago</span>
        </p>
      </div>
      ...
      <div className="card__feedback">
        ...
        <div className="card__feedback-number card--color-blue">{feedbackCount}</div>
        <button className="card__feedback-button">
